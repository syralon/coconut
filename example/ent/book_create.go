...
func (_c *BookCreate) SetAbstract(v string) *BookCreate {
	_c.mutation.SetAbstract(v)
	return _c
}

// SetNillableAbstract sets the "abstract" field if the given value is not nil.
func (_c *BookCreate) SetNillableAbstract(v *string) *BookCreate {
	if v != nil {
		_c.SetAbstract(*v)
	}
	return _c
...
func (_c *BookCreate) SetNillableID(v *int64) *BookCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
