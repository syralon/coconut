...
func Call[T any](fn func(T), val *T) {
	if val == nil {
		return
	}
	fn(*val)
...
type Int32FieldList []*Int32Field

func (f Int32FieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
...
type Uint32FieldList []*Uint32Field

func (f Uint32FieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type Int64FieldList []*Int64Field

func (f Int64FieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type Uint64FieldList []*Uint64Field

func (f Uint64FieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type FloatFieldList []*FloatField

func (f FloatFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type DoubleFieldList []*DoubleField

func (f DoubleFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type StringFieldList []*StringField

func (f StringFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type BoolFieldList []*BoolField

func (f BoolFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type DurationFieldList []*DurationField

func (f DurationFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type TimestampFieldList []*TimestampField

func (f TimestampFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
...
type BytesFieldList []*BytesField

func (f BytesFieldList) Selector(column string) []func(selector *sql.Selector) {
	var selectors = make([]func(selector *sql.Selector), 0, len(f))
	for _, v := range f {
		selectors = append(selectors, v.Selector(column)...)
	}
